...
sec = 5;                    % Secondi considerati per la fft
...
plotMode = 0;               % [0 = o+f, -1 = o, 1 = f] Indica quali segnali inserire nei plot (o = originale, f = filtrato)
...
f2 = 50;                    % Frequenza finale visualizzata dei plot degli spettri
